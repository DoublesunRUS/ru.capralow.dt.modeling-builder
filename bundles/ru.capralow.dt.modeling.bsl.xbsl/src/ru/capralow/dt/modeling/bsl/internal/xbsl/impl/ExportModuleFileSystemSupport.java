    ...
    implements IExportFileSystemSupport
{
        ...
        throws ExportException
    {
        ...
        if (moduleFileExtension == null)
        {
            try
            {
                moduleFileExtension = ModuleExporter.getModuleFileExtension(module);
            }
            catch (IOException e)
            {
                BslXBslPlugin.log(BslXBslPlugin
                    .createErrorStatus("ExportModuleFileSystemSupport: failed to get module extension: ", e));
            }
        }
        ...
        if (owner instanceof AbstractForm)
        {
            ...
            {
                BslXBslPlugin.log(BslXBslPlugin.createErrorStatus(
