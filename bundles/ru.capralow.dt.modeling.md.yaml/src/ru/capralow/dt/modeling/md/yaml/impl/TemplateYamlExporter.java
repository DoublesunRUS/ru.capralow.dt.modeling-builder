...
@Singleton
public class TemplateYamlExporter
    extends BasicExporter
{
    @Override
    public boolean isAppropriate(Version version, EObject eObject)
    {
        return eObject instanceof BasicTemplate && super.isAppropriate(version, eObject)
            && ((BasicTemplate)eObject).getTemplateType() != TemplateType.GEOGRAPHICAL_SCHEMA;
    }
