    ...
    implements ISpecifiedElementWriter
{
        ...
        Version version) throws ExportException
    {
        ...
        {
            ((ISpecifiedElementWriter)injector.getInstance(specifiedFeatureWriters.get(feature))).write(writer, eObject,
                feature, writeEmpty, version);
        }
        else if (specifiedClassifierWriters.containsKey(feature.getEType()))
        {
            ((ISpecifiedElementWriter)injector.getInstance(specifiedClassifierWriters.get(feature.getEType())))
                .write(writer, eObject, feature, writeEmpty, version);
        }
...
//        }
    ...
    private ImmutableMap<EStructuralFeature, Class<? extends ISpecifiedElementWriter>> fillSpecialFeatureWriters()
    {
        ...
        builder.put(MdClassPackage.Literals.CONFIGURATION__VENDOR, MetadataObjectWriter.class);

        //        builder.put(MdClassPackage.Literals.CONFIGURATION__COMPATIBILITY_MODE,
//            ConfigurationCompatibilityModeWriter.class);
...
//      RequiredMobileApplicationPermissionsWriter.class);
//  builder.put(MdClassPackage.Literals.CONFIGURATION__REQUIRED_MOBILE_APPLICATION_PERMISSIONS8315,
//      RequiredMobileApplicationPermissions8315Writer.class);
//  builder.put(MdClassPackage.Literals.CONFIGURATION__USED_MOBILE_APPLICATION_FUNCTIONALITIES,
//      UsedMobileApplicationFunctionalitiesWriter.class);
//  builder.put(MdClassPackage.Literals.CONFIGURATION__MOBILE_APPLICATION_URLS, MobileApplicationUrlsWriter.class);
...
//  builder.put(MdClassPackage.Literals.CONFIGURATION__MAIN_SECTION_PICTURE,
...
//  builder.put(MdClassPackage.Literals.CONFIGURATION__DEFAULT_ROLES, MdObjectRefItemsWriter.class);
...
//  builder.put(MdClassPackage.Literals.CONFIGURATION__DEFAULT_INTERFACE, MdObjectRefItemsWriter.class);
//  builder.put(MdClassPackage.Literals.CONFIGURATION__CONTENT, MdObjectRefItemsWriter.class);
...
//      builder.put(MdClassPackage.Literals.CATALOG__COMMANDS, MetadataObjectWriter.class);
//      builder.put(MdClassPackage.Literals.CATALOG__FORMS, ReferenceWriter.class);
//      builder.put(MdClassPackage.Literals.CATALOG__TEMPLATES, ReferenceWriter.class);
...
//        builder.put(MdClassPackage.Literals.CATALOG_PREDEFINED__ITEMS, PredefinedItemWriter.class);
//        builder.put(MdClassPackage.Literals.CATALOG_PREDEFINED_ITEM__CONTENT, PredefinedItemWriter.class);
//        builder.put(MdClassPackage.Literals.CATALOG_PREDEFINED_ITEM__CODE, PredefinedItemCodeWriter.class);
//        builder.put(MdClassPackage.Literals.CHART_OF_ACCOUNTS_PREDEFINED__ITEMS, PredefinedItemWriter.class);
//        builder.put(MdClassPackage.Literals.CHART_OF_ACCOUNTS_PREDEFINED_ITEM__CHILD_ITEMS, PredefinedItemWriter.class);
